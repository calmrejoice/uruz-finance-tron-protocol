...
contract CToken is CTokenInterface, Exponential, TokenErrorReporter {
    ...
    function transferTokens(address spender, address src, address dst, uint tokens) internal returns (uint) {
        ...
        emit UTokenBalance(src, srcTokensNew);
        emit UTokenBalance(dst, dstTokensNew);
    ...
    function mintFresh(address minter, uint mintAmount) internal returns (uint, uint) {
        ...
        //utoken event
        emit UTokenBalance(minter, vars.accountTokensNew);
    ...
    function redeemFresh(address payable redeemer, uint redeemTokensIn, uint redeemAmountIn) internal returns (uint) {
        ...
        //utoken event
        emit UTokenBalance(redeemer, vars.accountTokensNew);
    ...
    function seizeInternal(address seizerToken, address liquidator, address borrower, uint seizeTokens) internal returns (uint) {
        ...
        emit UTokenBalance(borrower, borrowerTokensNew);
        emit UTokenBalance(liquidator, liquidatorTokensNew);
    ...
    function statusSnapShot() internal {
        ...
        emit UTokenStatus(cash, totalBorrows, totalReserves, totalSupply, borrowRate, borrowIndex, reserveFactorMantissa);
    }
